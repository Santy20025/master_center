...
router.post('/autenticacion', (req, res) => {
    ...
    loginControlador.autenticarCliente(correo, contrasena, (err, cliente) => {
        ...
        return res.redirect('/cliente/inicio1.html'); // Redirige a index.html tras autenticación exitosa
    });
});
...
router.post('/autenticacion-loginn', (req, res) => {
    ...
    loginControlador.autenticarCliente(correo, contrasena, (err, cliente) => {
        ...
        return res.redirect('/inicio1.html'); // Redirige a reservas.html tras autenticación exitosa
    });
});
